...
public class Student_Test {
	...
	public static void data() throws PersonException {
		...
		studentRecords.add(new Student("Zachary", "Tanner", "Mahl", new GregorianCalendar(1996, 10, 1).getTime(),
				eMajor.COMPSI, "616 Main Street", "123-123-1234", "hava@udel.edu"));
		studentRecords.add(new Student("Jim", "The", "Office", new GregorianCalendar(1968, 8, 29).getTime(),
				eMajor.PHYSICS, "616 Main Street", "123-123-1234", "FlexD@udel.edu"));
		studentRecords
				.add(new Student("Pam", "The", "Office", new GregorianCalendar(1968, 8, 29).getTime(),
						eMajor.BUSINESS, "616 Main Street", "123-456-789", "hava@udel.edu"));
		studentRecords.add(new Student("Michael", "The", "Office", new GregorianCalendar(1990, 11, 27).getTime(),
				eMajor.COMPSI, "616 Main Street", "123-123-1234", "FlexD@udel.edu"));
		studentRecords
				.add(new Student("Leslie", "Knope", "ForPrez", new GregorianCalendar(1990, 5, 26).getTime(),
						eMajor.PHYSICS, "616 Main Street", "123-123-1234", "hava@udel.edu"));
		studentRecords.add(new Student("Kevin", "The", "Office", new GregorianCalendar(1998, 3, 2).getTime(),
				eMajor.BUSINESS, "616 Main Street", "123-123-1234", "FlexD@udel.edu"));
		studentRecords.add(new Student("Dwight", "The", "Office", new GregorianCalendar(1999, 7, 14).getTime(),
				eMajor.COMPSI, "616 Main Street", "123-1234-1234", "FlexD@udel.edu"));
		studentRecords.add(new Student("Angela", "The", "Office", new GregorianCalendar(1980, 8, 29).getTime(),
				eMajor.PHYSICS, "616 Main Street", "123-123-1234", "FlexD@udel.edu"));
		studentRecords.add(new Student("Stanley", "The", "Office", new GregorianCalendar(2001, 7, 1).getTime(),
				eMajor.BUSINESS, "616 Main Street", "123-123-1234", "FlexD@udel.edu"));
		studentRecords.add(new Student("Erin", "The", "Office", new GregorianCalendar(2001, 7, 1).getTime(),
				eMajor.COMPSI, "616 Main Street", "123-123-1234", "FlexD@udel.edu"));
	...
	public void tests() {
		...
		studentRecords.get(1).seteMajor(eMajor.PHYSICS);
		assertEquals(eMajor.PHYSICS, studentRecords.get(1).geteMajor());
